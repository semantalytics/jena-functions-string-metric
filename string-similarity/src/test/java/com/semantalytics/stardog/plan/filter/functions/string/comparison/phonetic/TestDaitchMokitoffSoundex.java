...
public class TestDaitchMokitoffSoundex extends AbstractStardogTest {
    ...
    public void testOneArgument() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix ss: <" + StringSimilarityVocab.NAMESPACE + "> " +
                    "select ?result where { bind(ss:daitchMokotoffSoundex(\"Stardog\") as ?result) }";
    ...
    public void testTooFewArgs() throws Exception {
        ...
        try {
            final String aQuery = "prefix ss: <" + StringSimilarityVocab.NAMESPACE + "> " +
                    "select ?result where { bind(ss:daitchMokotoffSoundex() as ?result) }";
    ...
    public void testFirstArgWrongType() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix ss: <" + StringSimilarityVocab.NAMESPACE + "> " +
                    "select ?result where { bind(ss:daitchMokotoffSoundex(7) as ?result) }";
