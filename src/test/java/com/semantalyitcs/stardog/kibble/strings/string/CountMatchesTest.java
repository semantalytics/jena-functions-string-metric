...
public class CountMatchesTest {
    ...
    public void testAbbreviateMiddle() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:countMatches(\"Stardog graph database\", \"...\", 8) AS ?abbreviation) }";
    ...
    public void testTooFewArgs() throws Exception {
        ...
        try {
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:countMatches(\"one\") as ?abbreviation) }";
    ...
    public void testTooManyArgs() throws Exception {
        ...
        try {
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:countMatches(\"one\", 2, \"three\") as ?abbreviation) }";
    ...
    public void testWrongTypeFirstArg() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:countMatches(4, 5) as ?abbreviation) }";
    ...
    public void testWrongTypeSecondArg() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:countMatches(\"one\", \"two\") as ?abbreviation) }";
    ...
    public void testLengthTooShort() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:countMatches(\"Stardog\", 3) as ?abbreviation) }";
