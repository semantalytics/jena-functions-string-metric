...
public final class LongestCommonSubsequence extends FunctionBase2 {
    ...
    public static final String name = StringMetricVocabulary.longestCommonSubsequence.stringValue();
    ...
    public NodeValue exec(final NodeValue arg0, final NodeValue arg1) {
        ...
        return makeDouble(longestCommonSubsequence.compare(firstString, secondString));
    }
