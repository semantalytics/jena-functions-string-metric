...
import com.semantalytics.stardog.kibble.geo.GeoVocabulary;
import org.junit.*;
...
public class TestGeohash {
    ...
    public void testLowerCamelToUpperUnderscoreByExample() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix ss: <" + GeoVocabulary.NAMESPACE + "> " +
    ...
    public void testLowerCamelToUpperCamelByExample() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix ss: <" + GeoVocabulary.NAMESPACE + "> " +
                    "select ?caseFormat where { bind(ss:caseFormat(\"caseFormat\", \"Latitude\", \"stardogUnion\") as ?caseFormat) }";
