...
public class ForegroundGreen extends AbstractFunction implements UserDefinedFunction {

    public ForegroundGreen() {
        super(1, "http://semantalytics.com/2017/11/ns/stardog/kibble/console/fgGreen");
    }
