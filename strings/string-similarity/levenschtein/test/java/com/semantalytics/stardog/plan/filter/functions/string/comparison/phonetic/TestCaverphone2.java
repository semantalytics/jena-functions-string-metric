...
public class TestCaverphone2 extends AbstractStardogTest {
    ...
    public void testOneArgument() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix ss: <" + StringSimilarityVocab.NAMESPACE + "> " +
                    "select ?result where { bind(ss:caverphone2(\"Stardog\") as ?result) }";
            ...
            try {
                ...
                assertEquals("STTK111111", aValue);
    ...
    public void testTooManyArgs() throws Exception {
        ...
        try {
            final String aQuery = "prefix ss: <" + StringSimilarityVocab.NAMESPACE + "> " +
                    "select ?result where { bind(ss:caverphone2(\"one\", \"two\") as ?result) }";
    ...
    public void testFirstArgumentWrongType() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix ss: <" + StringSimilarityVocab.NAMESPACE + "> " +
                    "select ?result where { bind(ss:caverphone2(7) as ?result) }";
