...
public class JoinTest {
    ...
    public void testAbbreviateMiddle() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:join(\"Stardog graph database\", \"...\", 8) AS ?abbreviation) }";
    ...
    public void testTooFewArgs() throws Exception {
        ...
        try {
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:join(\"one\") as ?abbreviation) }";
    ...
    public void testTooManyArgs() throws Exception {
        ...
        try {
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:join(\"one\", 2, \"three\") as ?abbreviation) }";
    ...
    public void testWrongTypeFirstArg() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:join(4, 5) as ?abbreviation) }";
    ...
    public void testWrongTypeSecondArg() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:join(\"one\", \"two\") as ?abbreviation) }";
    ...
    public void testLengthTooShort() throws Exception {
        ...
        try {
            ...
            final String aQuery = "prefix string: <" + StringVocabulary.NAMESPACE + "> " +
                    "select ?abbreviation where { bind(string:join(\"Stardog\", 3) as ?abbreviation) }";
